    ...
    >
      ...
      <div ref={containerRef} className="relative z-20 w-full max-w-6xl mx-auto px-6 mt-10"> {/* Added mt-10 */}
        ...
        <div className="text-center">
          ...
          <h2
            id="nama"
            className="text-4xl sm:text-5xl md:text-6xl lg:text-[70px] xl:text-[80px] text-white font-bold leading-tight mb-6 tracking-tight"
            style={{
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl hero-description bg-gradient-to-r from-white via-gray-300 to-gray-400 bg-clip-text text-transparent mt-6 leading-relaxed">
