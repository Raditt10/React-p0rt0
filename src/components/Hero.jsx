...
const Hero = () => {
  ...
  // FIX: Initialize theme directly from Storage/DOM to prevent invisible text on load
      ...
      >
        ...
        <motion.h1 
            ...
            style={{ 
                ...
                color: isLight ? '#000000' : '#ffffff', // Force correct color based on state
                transition: 'color 0.3s ease'
            }}
        >
            {/* Split by WORD first for better mobile wrapping */}
