    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          >
            <span className="bg-black/90 backdrop-blur-sm px-2.5 py-1 rounded-full text-xs font-bold text-cyan-300 shadow-lg border border-cyan-400/50 block md:ml-4">
          ...
          <div className="absolute left-5 md:left-1/2 top-0 bottom-0 w-0.5 bg-white/10 overflow-hidden">
            <motion.div
              className="absolute left-0 top-0 w-full bg-gradient-to-b from-purple-500 via-cyan-400 to-purple-500"
              style={{
              ...
              return (
                <div key={index} className="relative flex flex-col md:flex-row md:items-start">
                  ...
                  <div className={`w-full md:w-1/2 ${isLeft ? 'md:pr-6 lg:pr-8' : 'md:pl-6 lg:pl-8 md:order-2'}`}>
                    ...
                    >
                      <div className="relative group ml-12 md:ml-0">
                        ...
                        {/* Card - optimized */}
                        <div className={`relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-md border rounded-xl p-4 sm:p-5 md:p-6 transition-all duration-300 ${isActive ? 'border-white/20 shadow-lg shadow-purple-500/10' : 'border-white/10'} hover:border-white/30 hover:shadow-xl hover:shadow-purple-500/20`}>
                          {/* Year Badge */}
                          ...
                          {item.organizations && (
                            <div className="mt-4 pt-4 border-t border-white/10">
                              <h4 className="text-xs font-semibold text-cyan-400 mb-2">Organisasi & Ekstrakurikuler:</h4>
                              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                {item.organizations.map((org, orgIndex) => (
                                  ...
                                  >
                                    <div className="px-2.5 py-1.5 bg-white/10 backdrop-blur-sm border border-white/20 rounded-md hover:bg-white/15 hover:border-cyan-400/50 transition-all duration-200">
                          ...
                          <div className="absolute top-1.5 left-1.5 w-3 h-3 border-l-2 border-t-2 border-cyan-400/40 group-hover:border-cyan-400/70 transition-colors" />
                          <div className="absolute bottom-1.5 right-1.5 w-3 h-3 border-r-2 border-b-2 border-purple-400/40 group-hover:border-purple-400/70 transition-colors" />
                        </div>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  <motion.div
                    ...
                    animate={item.current ? { scale: [1.1, 1.25, 1.1] } : {}}
                    transition={{ duration: 2, repeat: item.current ? Infinity : 0 }}
                  />
